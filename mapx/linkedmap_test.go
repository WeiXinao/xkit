...
func newLinkedFakeMap[K any, V any](activeFirstErr bool, comparator xkit.Comparator[K]) (*LinkedMap[K, V], error) {
...
func TestLinkedMap_NewLinkedTreeMap(t *testing.T) {
	testCases := []struct {
		name       string
		comparator xkit.Comparator[int]

		wantErr error
	}{
		{
			name:       "no error",
			comparator: xkit.ComparatorRealNumber[int],
...
func TestLinkedMap_Put(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			name: "put single key",
			linkedMap: func(t *testing.T) *LinkedMap[int, int] {
				linkedTreeMap, err := NewLinkedTreeMap[int, int](xkit.ComparatorRealNumber[int])
		...
		},
		{
			...
			linkedMap: func(t *testing.T) *LinkedMap[int, int] {
				linkedFakeMap, err := newLinkedFakeMap[int, int](true, xkit.ComparatorRealNumber[int])
				assert.NoError(t, err)
...
func TestLinkedMap_Len(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			linkedMap: func(t *testing.T) *LinkedMap[int, int] {
				linkedTreeMap, _ := NewLinkedTreeMap[int, int](xkit.ComparatorRealNumber[int])
				return linkedTreeMap
			},
